Here is the workflow to create the files needed to calculate the heterozygosity per base pair per chromosome per sample, these csv files are needed to create figure 2.
